...
env.Append(
    ...
    LINKFLAGS=[
        ...
        "-Wl,--wrap=_Z21esp_matter_mem_callocjj",
        "-Wl,--wrap=_Z22esp_matter_mem_reallocPvj",
        "-Wl,--wrap=_Z19esp_matter_mem_freePv",
        "-Wl,--wrap=log_printf",
        "-Wl,--wrap=longjmp",
        ...
        "-u", "_Z5setupv",
        "-u", "_Z4loopv",
        "-u", "__wrap__ZN4chip11DeviceLayer8Internal10ESP32Utils13InitWiFiStackEv",
        "-u", "__wrap__Z21esp_matter_mem_callocjj",
        "-u", "__wrap__Z22esp_matter_mem_reallocPvj",
        "-u", "__wrap__Z19esp_matter_mem_freePv",
        "-u", "esp_app_desc",
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "common", "osal", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bt", "ble_profiles", "common", "include"),
    ...
    CPPDEFINES=[
        ...
        "ESP_PLATFORM",
        ("IDF_VER", '\\"v5.5.5-832-g2553c5ad432\\"'),
